...
class CombineTutorial(Node):
    ...
    def post(self, shared, prep_res, exec_res):
        ...
        doc_type = shared.get("doc_type", "tutorial")
        doc_type_display = "Software Architecture Document" if doc_type == "sad" else "Tutorial"
        print(f"\n{doc_type_display} generation complete! Files are in: {exec_res}")
